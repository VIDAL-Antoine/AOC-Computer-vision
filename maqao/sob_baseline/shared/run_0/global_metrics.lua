_report = {
  metrics = {
    ...
    compilation_flags = "sobel: GNU 10.2.0 -mtune=generic -march=x86-64 -g3 \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 90.53,
    speedup_if_fp_vect = 1.0207,
    ...
    speedup_if_fully_vectorised = 6.4118,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1999,
    profiled_time = 63.44,
    array_access_efficiency = 76.024062005228,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2677,
    nb_threads = 1,
    application_time = 63.44,
    compilation_options = "sobel:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 85.34,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 57.432232 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 54.139696 seconds.",
  },
  colors = {
