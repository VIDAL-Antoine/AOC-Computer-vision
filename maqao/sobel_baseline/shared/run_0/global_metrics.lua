_report = {
  metrics = {
    ...
    compilation_flags = "sobel: GNU 9.4.0 -mtune=generic -march=x86-64 -g3 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection \n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 90.32,
    speedup_if_fp_vect = 1.0114,
    ...
    speedup_if_fully_vectorised = 6.3516,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0869,
    profiled_time = 558.95,
    array_access_efficiency = 75.528214496605,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.4783,
    nb_threads = 1,
    application_time = 566.53051757813,
    compilation_options = "sobel:  -O2, -O3 or -Ofast is missing. -march=(target) is missing. -funroll-loops is missing. \n",
    innerloops_time = 87.95,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 504.84 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 491.60 seconds.",
  },
  colors = {
