_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 6.2358,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1973,
    profiled_time = 63.44,
    array_access_efficiency = 75.958263927448,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2639,
    nb_threads = 1,
  ...
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 57.12772 seconds.",
