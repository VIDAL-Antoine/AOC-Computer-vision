_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 3.1333,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.2244,
    profiled_time = 82.9,
    array_access_efficiency = 75.547947900681,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6794,
    nb_threads = 1,
    application_time = 324.04400634766,
    compilation_options = 25,
    innerloops_time = 83.81,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 70.22 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 69.48 seconds.",
  },
  colors = {
