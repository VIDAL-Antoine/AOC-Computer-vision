  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "ASM code",
          txt = "In the binary file, the address of the loop is: 1546\n\nInstruction                       | Nb FU | P0 | P1 | P2   | P3   | P4   | P5   | P6 | Latency | Recip. throughput\n------------------------------------------------------------------------------------------------------------------\nMOVQ $0,-0x8(%RBP)                | 1     | 0  | 0  | 0.50 | 0.50 | 0    | 0    | 1  | 1       | 1\nJMP 1537 <convolve_baseline+0x82> | 1     | 0  | 0  | 0    | 0    | 0    | 1    | 0  | 0       | 2\nADDQ $0x1,-0x10(%RBP)             | 1     | 0  | 0  | 1.50 | 0.50 | 0.50 | 0.50 | 1  | 7       | 1\nMOV -0x10(%RBP),%RAX              | 1     | 0  | 0  | 1    | 0    | 0    | 0    | 0  | 4       | 1\nCMP -0x38(%RBP),%RAX              | 1     | 0  | 0  | 1    | 0    | 0.50 | 0.50 | 0  | 1       | 1\nJB 14de <convolve_baseline+0x29>  | 1     | 0  | 0  | 0    | 0    | 0    | 1    | 0  | 0       | 1-2\n",
        },
      },
      header = {
