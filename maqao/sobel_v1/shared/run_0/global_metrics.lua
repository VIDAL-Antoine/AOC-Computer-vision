_report = {
  metrics = {
    ...
    loops_time = 84.61,
    speedup_if_fp_vect = 1.2011,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0108157282927,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0108157282927,
    ...
    speedup_if_fully_vectorised = 1.9756,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.0006,
    profiled_time = 19.91,
    array_access_efficiency = 64.859731093762,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.4936,
    nb_threads = 1,
    application_time = 22.808553695679,
    compilation_options = "OK",
    innerloops_time = 84.53,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 16.85 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 16.83 seconds.",
  },
  colors = {
