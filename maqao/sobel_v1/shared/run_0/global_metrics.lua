_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 6.1896,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.1089,
    profiled_time = 65.03,
    array_access_efficiency = 70.1361975418,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.1089,
    nb_threads = 1,
    application_time = 65.03,
    compilation_options = "sobel:  -O2, -O3 or -Ofast is missing. \n",
    innerloops_time = 86.34,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 58.728593 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 56.146902 seconds.",
  },
  colors = {
