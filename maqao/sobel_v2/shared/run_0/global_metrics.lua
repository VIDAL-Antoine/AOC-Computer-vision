_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.9002,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 13.87,
    array_access_efficiency = 67.513097563998,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 3.9194,
    nb_threads = 1,
    application_time = 22.735313415527,
    compilation_options = "OK",
    innerloops_time = 76.63,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.64 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.63 seconds.",
  },
  colors = {
