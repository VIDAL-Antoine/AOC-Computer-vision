_report = {
  metrics = {
    ...
    loops_time = 59.51,
    speedup_if_fp_vect = 1.0113,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.000100010001,
    ...
    speedup_if_fully_vectorised = 1.5833,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 18.13,
    array_access_efficiency = 63.453943677774,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.3761,
    nb_threads = 1,
    application_time = 33.007331848145,
    compilation_options = "OK",
    innerloops_time = 59.43,
  },
  help = {
