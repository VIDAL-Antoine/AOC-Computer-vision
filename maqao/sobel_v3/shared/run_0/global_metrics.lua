_report = {
  metrics = {
    ...
    loops_time = 62.42,
    speedup_if_fp_vect = 1.0118,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.000200040008,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.000200040008,
    ...
    speedup_if_fully_vectorised = 1.6308,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 17.33,
    array_access_efficiency = 63.408525826115,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5479,
    nb_threads = 1,
    application_time = 26.264068603516,
    compilation_options = "OK",
    innerloops_time = 62.34,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.82 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.80 seconds.",
  },
  colors = {
