_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0134792743488,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0134792743488,
    ...
    speedup_if_fully_vectorised = 1.6862,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 16.26,
    array_access_efficiency = 63.423340961098,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.7682,
    nb_threads = 1,
    application_time = 24.771175384521,
    compilation_options = "OK",
    innerloops_time = 65.55,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.67 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.66 seconds.",
  },
  colors = {
