_report = {
  metrics = {
    ...
    loops_time = 62.56,
    speedup_if_fp_vect = 1.012,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3164878338345,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0199918400653,
    ...
    speedup_if_fully_vectorised = 1.6325,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 11.08,
    array_access_efficiency = 63.434232287665,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5561,
    nb_threads = 2,
    application_time = 19.593074798584,
    compilation_options = "OK",
    innerloops_time = 62.48,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.93 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.92 seconds.",
  },
  colors = {
