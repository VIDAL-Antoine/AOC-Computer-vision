_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3445408886418,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0169836265636,
    ...
    speedup_if_fully_vectorised = 1.5119,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 12.94,
    array_access_efficiency = 63.431888970319,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1355,
    nb_threads = 2,
    application_time = 22.065624237061,
    compilation_options = "OK",
    innerloops_time = 54.58,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.07 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.06 seconds.",
  },
  colors = {
