_report = {
  metrics = {
    ...
    loops_time = 64.05,
    speedup_if_fp_vect = 1.0121,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3057298483776,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0210332856851,
    ...
    speedup_if_fully_vectorised = 1.6574,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 10.76,
    array_access_efficiency = 63.407770657497,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.6547,
    nb_threads = 2,
    application_time = 19.615306854248,
    compilation_options = "OK",
    innerloops_time = 63.99,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 6.89 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 6.89 seconds.",
  },
  colors = {
