_report = {
  metrics = {
    ...
    loops_time = 55.2,
    speedup_if_fp_vect = 1.0105,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3551505951649,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0167768174886,
    ...
    speedup_if_fully_vectorised = 1.5206,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 12.95,
    array_access_efficiency = 63.438823351482,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1602,
    nb_threads = 2,
    application_time = 22.010412216187,
    compilation_options = "OK",
    innerloops_time = 55.1,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 7.15 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 7.14 seconds.",
  },
  colors = {
