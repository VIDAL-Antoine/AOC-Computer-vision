_report = {
  metrics = {
    ...
    loops_time = 55.9,
    speedup_if_fp_vect = 1.0107,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1120468681817,
    ...
    speedup_if_fully_vectorised = 1.5298,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 9.87,
    array_access_efficiency = 63.45287191441,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1924,
    nb_threads = 4,
    application_time = 18.56590461731,
    compilation_options = "OK",
    innerloops_time = 55.77,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.52 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.50 seconds.",
  },
  colors = {
