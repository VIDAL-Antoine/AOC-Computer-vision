_report = {
  metrics = {
    ...
    loops_time = 52.67,
    speedup_if_fp_vect = 1.0101,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1957166112467,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0206164523372,
    ...
    speedup_if_fully_vectorised = 1.4845,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 10.97,
    array_access_efficiency = 63.438035000951,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.0511,
    nb_threads = 4,
    application_time = 19.886669158936,
    compilation_options = "OK",
    innerloops_time = 52.57,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.78 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.77 seconds.",
  },
  colors = {
