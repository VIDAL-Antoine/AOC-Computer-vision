_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.997006412754,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0259567046271,
    ...
    speedup_if_fully_vectorised = 1.5857,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 8.83,
    array_access_efficiency = 63.421509349457,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.3811,
    nb_threads = 4,
    application_time = 17.508359909058,
    compilation_options = "OK",
    innerloops_time = 59.54,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.26 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.26 seconds.",
  },
  colors = {
