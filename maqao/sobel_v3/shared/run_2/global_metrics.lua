_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.9172831977705,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0281719103434,
    ...
    speedup_if_fully_vectorised = 1.6344,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 8.03,
    array_access_efficiency = 63.443946905485,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5595,
    nb_threads = 4,
    application_time = 17.08017539978,
    compilation_options = "OK",
    innerloops_time = 62.54,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 5.03 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 5.02 seconds.",
  },
  colors = {
