_report = {
  metrics = {
    ...
    loops_time = 61.77,
    speedup_if_fp_vect = 1.0117,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 3.1046519334314,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0354110581901,
    ...
    speedup_if_fully_vectorised = 1.6205,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 6.57,
    array_access_efficiency = 63.418598994649,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5062,
    nb_threads = 8,
    application_time = 15.623390197754,
    compilation_options = "OK",
    innerloops_time = 61.68,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.06 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.05 seconds.",
  },
  colors = {
