_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.9738170595441,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.037021673753,
    ...
    speedup_if_fully_vectorised = 1.6595,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 6.07,
    array_access_efficiency = 63.430102492066,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.661,
    nb_threads = 8,
    application_time = 15.093223571777,
    compilation_options = "OK",
    innerloops_time = 64.07,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.89 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.89 seconds.",
  },
  colors = {
