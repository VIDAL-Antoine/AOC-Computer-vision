_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.9749453818621,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0405827263267,
    ...
    speedup_if_fully_vectorised = 1.6653,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 6.04,
    array_access_efficiency = 63.430607331469,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.6832,
    nb_threads = 8,
    application_time = 15.057642936707,
    compilation_options = "OK",
    innerloops_time = 64.38,
  },
  help = {
