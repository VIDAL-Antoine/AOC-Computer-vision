_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 3.0976518667016,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.037667323856,
    ...
    speedup_if_fully_vectorised = 1.6219,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 6.5,
    array_access_efficiency = 63.459600043122,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5162,
    nb_threads = 8,
    application_time = 15.521936416626,
    compilation_options = "OK",
    innerloops_time = 61.85,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 4.03 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 4.02 seconds.",
  },
  colors = {
