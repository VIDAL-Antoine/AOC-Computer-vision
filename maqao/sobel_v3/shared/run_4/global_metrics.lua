_report = {
  metrics = {
    ...
    loops_time = 65,
    speedup_if_fp_vect = 1.0122,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 5.0599725416962,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0458063166702,
    ...
    speedup_if_fully_vectorised = 1.6757,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000875076569,
    speedup_if_clean = 1,
    profiled_time = 5.09,
    array_access_efficiency = 63.393031376778,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.7204,
    nb_threads = 16,
    application_time = 14.143460273743,
    compilation_options = "OK",
    innerloops_time = 64.92,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.31 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.30 seconds.",
  },
  colors = {
