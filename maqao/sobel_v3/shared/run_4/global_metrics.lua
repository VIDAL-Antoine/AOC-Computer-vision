_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 5.1199432988306,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0463534581982,
    ...
    speedup_if_fully_vectorised = 1.6436,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 5.23,
    array_access_efficiency = 63.432426734135,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.6023,
    nb_threads = 16,
    application_time = 14.282631874084,
    compilation_options = "OK",
    innerloops_time = 63.24,
  },
  help = {
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.31 seconds.",
  },
  colors = {
