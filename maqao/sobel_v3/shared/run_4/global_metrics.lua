_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 5.0448481139926,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0456969570219,
    ...
    speedup_if_fully_vectorised = 1.6733,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 5.06,
    array_access_efficiency = 63.412012753265,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.716,
    nb_threads = 16,
    application_time = 14.080144882202,
    compilation_options = "OK",
    innerloops_time = 64.83,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.29 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.28 seconds.",
  },
  colors = {
