_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 7.8235189070398,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0495382031906,
    ...
    speedup_if_fully_vectorised = 1.7118,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 4.83,
    array_access_efficiency = 63.408445440957,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.8739,
    nb_threads = 32,
    application_time = 13.631403923035,
    compilation_options = "OK",
    innerloops_time = 66.9,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.24 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.23 seconds.",
  },
  colors = {
