_report = {
  metrics = {
    ...
    loops_time = 65.68,
    speedup_if_fp_vect = 1.0124,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 7.9588609628853,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0471204188482,
    ...
    speedup_if_fully_vectorised = 1.689,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 5.05,
    array_access_efficiency = 63.389189670073,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.7705,
    nb_threads = 32,
    application_time = 13.480373382568,
    compilation_options = "OK",
    innerloops_time = 65.57,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.32 seconds.",
