_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 8.1196651262725,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0449320794148,
    ...
    speedup_if_fully_vectorised = 1.6766,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 5.2,
    array_access_efficiency = 63.398571942261,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.7198,
    nb_threads = 32,
    application_time = 13.578078269958,
    compilation_options = "OK",
    innerloops_time = 64.89,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.38 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.37 seconds.",
  },
  colors = {
