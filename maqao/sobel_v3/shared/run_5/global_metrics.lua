_report = {
  metrics = {
    ...
    loops_time = 67.12,
    speedup_if_fp_vect = 1.0127,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 7.7926442308863,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0483279169724,
    ...
    speedup_if_fully_vectorised = 1.7146,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 4.8,
    array_access_efficiency = 63.407642519293,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.8822,
    nb_threads = 32,
    application_time = 13.847707748413,
    compilation_options = "OK",
    innerloops_time = 66.95,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.22 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.21 seconds.",
  },
  colors = {
