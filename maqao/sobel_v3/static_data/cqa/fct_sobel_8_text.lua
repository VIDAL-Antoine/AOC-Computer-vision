  ...
  paths = {
    {
      ...
      expert = {
        ...
        {
          title = "Back-end",
          txt = "       | P0    | P1   | P2   | P3   | P4    | P5    | P6\n-----------------------------------------------------------\nuops   | 19.00 | 0.00 | 5.50 | 5.50 | 24.00 | 24.00 | 10.00\ncycles | 19.00 | 0.00 | 5.50 | 5.50 | 24.00 | 24.00 | 10.00\n\nCycles executing div or sqrt instructions: 22.00-95.00\n",
        },
        {
          title = "Cycles summary",
          txt = "Front-end : 31.00\nDispatch  : 24.00\nDIV/SQRT  : 22.00-95.00\nOverall L1: 31.00-95.00\n",
        },
        {
      ...
      gain = {
        ...
        },
        {
          ...
          txt = "Performance is limited by execution of divide and square root operations (the divide/square root unit is a bottleneck).\n\nBy removing all these bottlenecks, you can lower the cost of an iteration from 95.00 to 31.00 cycles (3.06x speedup).\n",
        },
      },
      potential = {
        {
          title = "Expensive FP math instructions/calls",
          txt = "Detected performance impact from expensive FP math instructions/calls.\nBy removing/reexpressing them, you can lower the cost of an iteration from 95.00 to 31.00 cycles (3.06x speedup).",
        },
      },
    },
  },
