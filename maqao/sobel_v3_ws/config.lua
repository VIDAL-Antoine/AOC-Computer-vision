...
multiruns_params = {
  {name="2T", envv_OMP_NUM_THREADS="2", run_command = "<executable> in/input_ws_2.raw sout/output_ws_2.raw"},
  {name="4T", envv_OMP_NUM_THREADS="4", run_command = "<executable> in/input_ws_4.raw sout/output_ws_4.raw"},
}
