...
multiruns_params = {
  {run_command = "<executable> in/input_ws_2.raw sout/output_ws_2.raw", environment_variables = {{name = "OMP_NUM_THREADS", value = "2",},},name = "2T",},
  {run_command = "<executable> in/input_ws_4.raw sout/output_ws_4.raw", environment_variables = {{name = "OMP_NUM_THREADS", value = "4",},},name = "4T",},
}
