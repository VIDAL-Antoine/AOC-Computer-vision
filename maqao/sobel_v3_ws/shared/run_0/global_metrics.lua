_report = {
  metrics = {
    ...
    loops_time = 66.14,
    speedup_if_fp_vect = 1.0125,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0133765707337,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0133765707337,
    ...
    speedup_if_fully_vectorised = 1.6947,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 16.25,
    array_access_efficiency = 63.415961720142,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.8066,
    nb_threads = 1,
    application_time = 23.942541122437,
    compilation_options = "OK",
    innerloops_time = 66.03,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.75 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.73 seconds.",
  },
  colors = {
