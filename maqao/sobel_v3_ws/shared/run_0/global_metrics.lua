_report = {
  metrics = {
    ...
    loops_time = 64.51,
    speedup_if_fp_vect = 1.0123,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0138902970699,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0138902970699,
    ...
    speedup_if_fully_vectorised = 1.6656,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 16.45,
    array_access_efficiency = 63.446468297081,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.6867,
    nb_threads = 1,
    application_time = 25.229490280151,
    compilation_options = "OK",
    innerloops_time = 64.43,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.61 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.60 seconds.",
  },
  colors = {
