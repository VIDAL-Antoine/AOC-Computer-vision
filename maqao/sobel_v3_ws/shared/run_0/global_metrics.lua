_report = {
  metrics = {
    ...
    loops_time = 57.46,
    speedup_if_fp_vect = 1.0109,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0116337885685,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0116337885685,
    ...
    speedup_if_fully_vectorised = 1.553,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 18.77,
    array_access_efficiency = 63.418205843062,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.2683,
    nb_threads = 1,
    application_time = 26.964044570923,
    compilation_options = "OK",
    innerloops_time = 57.39,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.79 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.77 seconds.",
  },
  colors = {
