_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0126582278481,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0126582278481,
    ...
    speedup_if_fully_vectorised = 1.6232,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 17.28,
    array_access_efficiency = 63.452246326641,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.5201,
    nb_threads = 1,
    application_time = 26.086191177368,
    compilation_options = "OK",
    innerloops_time = 61.9,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 10.71 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 10.70 seconds.",
  },
  colors = {
