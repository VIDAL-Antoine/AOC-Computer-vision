_report = {
  metrics = {
    ...
    loops_time = 54.22,
    speedup_if_fp_vect = 1.0104,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3659278154952,
    ...
    speedup_if_fully_vectorised = 1.5053,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 26.86,
    array_access_efficiency = 63.47595299664,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1171,
    nb_threads = 2,
    application_time = 39.034450531006,
    compilation_options = "OK",
    innerloops_time = 54.14,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.56 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 14.54 seconds.",
  },
  colors = {
