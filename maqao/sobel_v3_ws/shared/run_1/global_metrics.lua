_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3429072571804,
    ...
    speedup_if_fully_vectorised = 1.552,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 24.99,
    array_access_efficiency = 63.415735730494,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.2636,
    nb_threads = 2,
    application_time = 50.298377990723,
    compilation_options = "OK",
    innerloops_time = 57.29,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.34 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 14.32 seconds.",
  },
  colors = {
