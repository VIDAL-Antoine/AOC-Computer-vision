_report = {
  metrics = {
    ...
    loops_time = 56.76,
    speedup_if_fp_vect = 1.0108,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.3579319982578,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0060362173038,
    ...
    speedup_if_fully_vectorised = 1.5426,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 25.43,
    array_access_efficiency = 63.444252612831,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.2339,
    nb_threads = 2,
    application_time = 48.622959136963,
    compilation_options = "OK",
    innerloops_time = 56.68,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 14.43 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 14.41 seconds.",
  },
  colors = {
