_report = {
  metrics = {
    ...
    loops_time = 49.82,
    speedup_if_fp_vect = 1.0094,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.2432910860474,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.000100010001,
    ...
    speedup_if_fully_vectorised = 1.4461,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 48.01,
    array_access_efficiency = 63.431953653473,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.9414,
    nb_threads = 4,
    application_time = 83.231155395508,
    compilation_options = "OK",
    innerloops_time = 49.77,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 23.92 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 23.89 seconds.",
  },
  colors = {
