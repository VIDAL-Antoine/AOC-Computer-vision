_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1950053565219,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.020199959192,
    ...
    speedup_if_fully_vectorised = 1.4794,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 44.28,
    array_access_efficiency = 63.443688767373,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.037,
    nb_threads = 4,
    application_time = 90.461700439453,
    compilation_options = "OK",
    innerloops_time = 52.25,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 23.16 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 23.14 seconds.",
  },
  colors = {
