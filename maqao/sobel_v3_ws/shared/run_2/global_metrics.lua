_report = {
  metrics = {
    ...
    loops_time = 45.02,
    speedup_if_fp_vect = 1.0085,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.2893345232132,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0127607859024,
    ...
    speedup_if_fully_vectorised = 1.3866,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 54.23,
    array_access_efficiency = 63.452049896711,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.7794,
    nb_threads = 4,
    application_time = 103.04644012451,
    compilation_options = "OK",
    innerloops_time = 44.95,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 24.41 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 24.38 seconds.",
  },
  colors = {
