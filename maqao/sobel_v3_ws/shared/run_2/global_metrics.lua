_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.1409036260905,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0131712259372,
    ...
    speedup_if_fully_vectorised = 1.479,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 43.66,
    array_access_efficiency = 63.427333296851,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.0355,
    nb_threads = 4,
    application_time = 84.933647155762,
    compilation_options = "OK",
    innerloops_time = 52.21,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 22.83 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 22.79 seconds.",
  },
  colors = {
