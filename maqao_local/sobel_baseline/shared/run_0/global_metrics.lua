_report = {
  metrics = {
    ...
    compilation_flags = "sobel: GNU C17 11.3.0 -mtune=generic -march=x86-64 -g3 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection\n",
    speedup_if_perfect_openmp = "Not Available",
    __name = "run_0",
    nb_loops_80_if_L1 = "Not Available",
    loops_time = 83.43,
    speedup_if_fp_vect = 1.011,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0017028949214,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0017028949214,
    ...
    speedup_if_fully_vectorised = 3.0333,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1.2169,
    profiled_time = 67.26,
    array_access_efficiency = 75.547864477206,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6576,
    nb_threads = 1,
    application_time = 175.32643127441,
    compilation_options = 25,
    innerloops_time = 82.56,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 56.12 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 55.53 seconds.",
  },
  colors = {
  ...
  comp_opt_report = {
    ...
    ["sobel#sobel.c"] = {
      opts = "GNU C17 11.3.0 -mtune=generic -march=x86-64 -g3 -fasynchronous-unwind-tables -fstack-protector-strong -fstack-clash-protection -fcf-protection",
      score = "0.25",
      issues = {"-O2, -O3 or -Ofast is missing. ", "-march=(target) is missing. ", "-funroll-loops is missing. ", },
    },
  },
}
