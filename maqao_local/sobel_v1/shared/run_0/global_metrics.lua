_report = {
  metrics = {
    ...
    loops_time = 73.95,
    speedup_if_fp_vect = 1.0011,
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.0241704219582,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0241704219582,
    ...
    speedup_if_fully_vectorised = 1.1286,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0001500225034,
    speedup_if_clean = 1,
    profiled_time = 4.28,
    array_access_efficiency = 96.991779693322,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.2352,
    nb_threads = 1,
    application_time = 160.47331237793,
    compilation_options = 100,
    innerloops_time = 73.95,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 3.17 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 3.17 seconds.",
  },
  colors = {
