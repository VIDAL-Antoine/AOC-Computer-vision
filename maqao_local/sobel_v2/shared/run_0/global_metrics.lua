_report = {
  metrics = {
    ...
    speedup_if_fully_vectorised = 1.4608,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 2.93,
    array_access_efficiency = 99.047672368953,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1195,
    nb_threads = 1,
    application_time = 135.71185302734,
    compilation_options = 100,
    innerloops_time = 62.92,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.84 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.84 seconds.",
  },
  colors = {
