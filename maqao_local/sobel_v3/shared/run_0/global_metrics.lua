_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.5393483322023,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.1057054400708,
    ...
    speedup_if_fully_vectorised = 2.0684,
    ...
    number_processes = 1,
    speedup_if_FP_only = 2.0928,
    nb_threads = 8,
    application_time = 196.59857177734,
    compilation_options = 100,
    innerloops_time = 63.54,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.88 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.87 seconds.",
  },
  colors = {
