_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.9062718572215,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0374520178442,
    ...
    speedup_if_fully_vectorised = 1.4833,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 2.49,
    array_access_efficiency = 99.027430404524,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.2748,
    nb_threads = 8,
    application_time = 320.92730712891,
    compilation_options = 100,
    innerloops_time = 66.81,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.67 seconds.",
