_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 1.4906461951256,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0344470880314,
    ...
    speedup_if_fully_vectorised = 1.2868,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0001500225034,
    speedup_if_clean = 1,
    profiled_time = 3.04,
    array_access_efficiency = 99.013891937372,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6221,
    nb_threads = 2,
    application_time = 135.70036315918,
    compilation_options = 100,
    innerloops_time = 45.53,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.39 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.38 seconds.",
  },
  colors = {
