_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.4029693835954,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0355182768976,
    ...
    speedup_if_fully_vectorised = 1.3068,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 2.8,
    array_access_efficiency = 99.052205484962,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 1.6807,
    nb_threads = 4,
    application_time = 151.13163757324,
    compilation_options = 100,
    innerloops_time = 48.2,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.35 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.35 seconds.",
  },
  colors = {
