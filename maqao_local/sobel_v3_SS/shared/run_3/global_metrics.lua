_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.8886426835039,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0377750103778,
    ...
    speedup_if_fully_vectorised = 1.4571,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1,
    speedup_if_clean = 1,
    profiled_time = 2.56,
    array_access_efficiency = 99.087398018648,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.1831,
    nb_threads = 8,
    application_time = 158.09027099609,
    compilation_options = 100,
    innerloops_time = 64.93,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.66 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.66 seconds.",
  },
  colors = {
