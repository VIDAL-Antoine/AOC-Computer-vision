_report = {
  metrics = {
    ...
    speedup_if_perfect_MPI_OMP_PTHREAD_LOAD_DISTRIBUTION = 2.8109858279945,
    speedup_if_perfect_MPI_OMP_PTHREAD = 1.0435145570281,
    ...
    speedup_if_fully_vectorised = 1.506,
    nb_loops_80_if_fp_vect = 1,
    flow_complexity = 1.0000750056254,
    speedup_if_clean = 1,
    profiled_time = 2.44,
    array_access_efficiency = 99.042946240933,
    crest_performance = "Not Implemented Yet",
    number_processes = 1,
    speedup_if_FP_only = 2.2826,
    nb_threads = 8,
    application_time = 137.7141418457,
    compilation_options = 100,
    innerloops_time = 67.05,
  },
  help = {
    ...
    loops_time = "Percentage of the application time spent in loops (excluding loops present in modules not analyzed by the profiler). It represents 1.64 seconds.",
    ...
    innerloops_time = "Percentage of the application time spent in innermost loops (excluding loops present in modules not analyzed by the profiler). It represents 1.64 seconds.",
  },
  colors = {
