...
then
    ...
    ./cvt_vid.sh v2r "in/input_ws.mp4" "in/input_ws.raw" >> /dev/null 2>> /dev/null
fi
...
do
  ...
  ./cvt_vid.sh r2v "sout/output_ws.raw" "sout/output_"$variant".mp4" >> $dir"/logs/cvt.log" 2>> $dir"/logs/cvt_err.log"
